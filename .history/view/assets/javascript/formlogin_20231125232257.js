...
<div class="modal-form">
  <button type="button" class="closeForm">
    <i class="fa-solid fa-xmark closeForm"></i>
  </button>
...
document.body.addEventListener("click", (event) => {
  if (event.target.matches(".closeLogin")) {
    const modalLogin = document.querySelector(".body-form-login");
    modalLogin.parentNode.removeChild(modalLogin);
  } else if (event.target.matches(".body-form-login")) {
