...
<div class="modal-form">
  <button type="button" class="gobacksignin">
  ...
  <div class="content-form-login">
    <ul class="list-login">
      <li>
        <a href="#" class="login-btn login-password">
...
const signinPassword = `
    <form class="formSignup" action="" method="get" onsubmit="return">
...
openForm.addEventListener("click", () => {
  ...
  if (formLogin) {
    ...
    const contentFormLogin = document.querySelector(".content-form-login");
    const goBackSignin = document.querySelector(".gobacksignin");

    loginPassword.addEventListener("click", () => {
      contentFormLogin.insertAdjacentHTML("afterend", signinPassword);
      contentFormLogin.style.display = "none";
      goBackSignin.style.display = "flex";
      ...
      if (signinPassword) {
        ...
        goBackSignin.addEventListener("click", (evt) => {
          const formSignup = document.querySelector(".formSignup");
          formSignup.parentNode.removeChild(formSignup);
          contentFormLogin.style.display = "block";
        });
      }
    });
  }
