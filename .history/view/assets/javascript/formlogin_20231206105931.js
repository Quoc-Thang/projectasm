...
const signinPassword = `<div class="body-form body-form-signup">
<div class="modal-form">
    ...
    loginPassword.addEventListener("click", () => {
      ...
      if (signinPassword) {
        if (formSingup) {
          ...
          const ComebackSignin = document.querySelector(".gobackSignin");
          ComebackSignin.addEventListener("click", () => {
            signinPassword.parentNode.removeChild(signinPassword);
          });
        }
      }
    });
